        ...
        try {
            ...
            for (int i = 0; i < 5; i++) {
                try {
                    ...
                    String recebi = "Recebido!";
                    hansdshack = new DatagramPacket(recebi.getBytes(), recebi.length(), packet.getAddress(), 1234);
                    socket.send(hansdshack);
